...
class sfTCPDF extends TCPDF
{
  ...
  public function __construct($orientation = 'P', $unit = 'mm', $format = 'A4', $unicode = true, $encoding = "UTF-8")
  {
    ...
    public function Header() {
        ...
        $this->Image($image_file, 5, 10, 35, 15, 'JPG', '', 'T', false, 300, '', false, false, 0, false, false, false);
        // Set font
        $this->SetFont('helvetica', 'B', 12);
        // Title
        $this->Cell(160, 15, 'Scontrino n. 3355', 0, false, 'R', 0, '', 0, false, 'T', 'B');
        $this->Line(0,25,200,25);
    }
