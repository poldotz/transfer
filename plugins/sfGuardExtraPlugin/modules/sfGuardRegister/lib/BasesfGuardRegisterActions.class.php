  ...
  public function executeRegister(sfWebRequest $request)
  {
    ...
    if ($request->isMethod(sfRequest::POST))
    {
      ...
      if ($this->form->isValid())
      {
        ...
        $my_sme = $mensagem->embed(Swift_Image::fromPath('images/my_sme.png'));
        $smeppo = $mensagem->embed(Swift_Image::fromPath('images/smeppo.png'));
        ...
        //$mailer->send($message);
          ...
          $mensagem->setFrom(array($from=>$fromName))
