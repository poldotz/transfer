...
abstract class BasesfGuardUser extends BaseObject implements Persistent
{
     ...
     * @return PropelObjectCollection|SfGuardUserProfile[] List of SfGuardUserProfile objects
     */
    public function getSfGuardUserProfilesJoinComune($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = SfGuardUserProfileQuery::create(null, $criteria);
        $query->joinWith('Comune', $join_behavior);
     ...
     * @return PropelObjectCollection|SfGuardUserProfile[] List of SfGuardUserProfile objects
     */
    public function getSfGuardUserProfilesJoinFidelityCard($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = SfGuardUserProfileQuery::create(null, $criteria);
        $query->joinWith('FidelityCard', $join_behavior);
